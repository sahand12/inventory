...
console.log(docs);
        ...
        workflow.on('createPDFReport', function (docs) {
            ...
            console.log('avataart', avatarPath);
            ...
            doc.fillColor('#3eb39e').fontSize(13).text('DATE', 25, 240, { width: 85, align: 'left' });
            ...
            doc.fillColor('#3eb39e').fontSize(13).text('AMOUNT', 444, 240, { width: 128, align: 'left' });
            ...
            for (var i = 0, len = data.length; i < len; i++) {
                ...
                doc.fillColor('#464646').fontSize(11).text(formatDateForTable(exp.date), 23, y, { width: 85, align: 'left' });
                ...
                doc.fillColor('red').fontSize(11).text("IRR " + formatAmount(exp.amount), 444, y, { width: 128, align: 'left' }).moveDown();
                if (i === 12) {
                    ...
                    doc.addPage();
                    y = doc.y;
                    doc.fillColor('#3eb39e').fontSize(13).text('DATE', 25, y, { width: 85, align: 'left' });
                    ...
                    doc.fillColor('#3eb39e').fontSize(13).text('AMOUNT', 444, y, { width: 128, align: 'left' });
                    doc.y += 5;
                }
                if ( i > 18 && (i + 1 < len) && ((i - 12) % 17 === 0) ) {
